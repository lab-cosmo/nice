...
def main():
    ...
    def get_nice():
        ...
        for nu in range(1, numax-1): # this starts from nu=2 actually
            #print(nu,"numexpcov",numexpcov[nu-1],"maxtakecov",maxtakecov[nu-1],"ncompcov",ncompcov[nu-1],"numexpinv",numexpinv[nu-1],"maxtakeinv",maxtakeinv[nu-1],"ncompinv",ncompinv[nu-1])
            sb.append(
    ...
    # at the last order, we only need invariants
        #print(nu+1,"numexpcov",numexpcov[numax-2],"maxtakecov",maxtakecov[numax-2],"ncompcov",ncompcov[numax-2],"numexpinv",numexpinv[numax-2],"maxtakeinv",maxtakeinv[numax-2],"ncompinv",ncompinv[numax-2])
        sb.append(
    ...
    #print("Getting all species: ",all_species)
    ...
    """
    #print("Getting coefficients ",HYPERS)
